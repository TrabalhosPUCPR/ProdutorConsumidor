...
public class Main {
    public static void main(String[] args) {
        ...
        // lojas
        int[] store_delay = new int[]{100, 1500};
        ...
        int[] fabricator1_delays = new int[]{600, 200, 1000, 400, 800, 1400, 400, 800};
        int[] fabricator2_delays = new int[]{400, 800, 1200, 800, 200, 1000, 1000, 600};
        int[] fabricator3_delays = new int[]{1000, 1200, 400, 600, 400, 400, 1000, 400};
        int[] fabricator4_delays = new int[]{800, 600, 400, 1000, 1200, 800, 600, 1200};
        ...
        transporters[0] = new Transporter("A", sem_transport, fila_entregas, new int[]{100, 200}, 10);
        transporters[1] = new Transporter("B", sem_transport, fila_entregas, new int[]{400, 600}, 20);

        String output_path = "src/output.txt";

        Report store_reports = new StoreReport("Store", output_path, stores);
        Report fabricator_reports = new FabricatorReport("Fabricator", output_path, fabricators);
        Report transporter_reports = new TransporterReport("Transporter", output_path, transporters);
        ...
        while(System.currentTimeMillis() - start <= 1440){}
        System.out.println("\nFechado!");
